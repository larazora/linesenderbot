...
#これはTwitterAPIのキーのコード
CONSUMER_KEY = 'imfILpwW6LhxxGcILcJQ5Hu0b'
CONSUMER_SECRET = 'bn1upmthn2lenhuaheiBEhvtVRzf7qBJtu23S0ZciB2xljhq4P'
ACCESS_TOKEN = '1317127647944531970-3gk23QkNPRSr9yvKPUkJJG1EhRnnnM'
ACCESS_TOKEN_SECRET = 'xfaBsfUqQausudFN5PJXsxiOgnXGoh11IaVpROLaxlSML'

twitter = OAuth1Session(CONSUMER_KEY,CONSUMER_SECRET,ACCESS_TOKEN,ACCESS_TOKEN_SECERET)
